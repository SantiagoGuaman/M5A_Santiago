 ...
 * 
 */
@WebServiceClient(name = "ConversionWS", targetNamespace = "http://sw/", wsdlLocation = "http://localhost:8080/WebServiceSOAPGuia/ConversionWS?WSDL")
    ...
    extends Service
{
    ...
    private final static QName CONVERSIONWS_QNAME = new QName("http://sw/", "ConversionWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebServiceSOAPGuia/ConversionWS?WSDL");
    ...
    public ConversionWS getConversionWSPort() {
        return super.getPort(new QName("http://sw/", "ConversionWSPort"), ConversionWS.class);
    }
    ...
    public ConversionWS getConversionWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sw/", "ConversionWSPort"), ConversionWS.class, features);
    }
